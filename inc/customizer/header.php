...
/**
 * Migrate legacy secondary CTA background from green to black.
 */
add_action( 'after_setup_theme', function () {
    if ( get_option( 'muuttohaukat_migrated_cta_secondary_bg', false ) ) {
        return;
    }

    $bg = get_theme_mod( 'muuttohaukat_cta_secondary_bg' );
    if ( $bg && strcasecmp( $bg, '#22c55e' ) === 0 ) {
        set_theme_mod( 'muuttohaukat_cta_secondary_bg', '#000000' );
    }

    update_option( 'muuttohaukat_migrated_cta_secondary_bg', true );
}, 20 );
