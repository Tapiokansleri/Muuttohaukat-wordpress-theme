...
class App {
  ...
  public function getOption($x, $languageSlug = null) {
    ...
    return \function_exists('get_field') ? \get_field($optionName, 'options') : null;
  }
  ...
  private function __construct($options = []) {
    ...
    $has_acf_blocks = function_exists('acf_register_block_type') || function_exists('acf_register_block');
    ...
    if (!$has_acf_blocks) {
      add_action('admin_notices', function () {
        ...
        echo esc_html__('Muuttohaukat requires ACF Pro for its custom blocks. The theme remains active, but ACF blocks are unavailable.', 'muuttohaukat');
        echo '</p></div>';
      });
      return;
    }
